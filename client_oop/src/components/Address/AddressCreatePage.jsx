...
class AddressCreatePage extends BaseComponent {
  constructor(props) {
    super(props);
  ...
  async handleSubmit(event) {
    ...
    const {token, id, street, city, province, country, postal_code} =
      this.state;
    const response = await addressApi.createAddress(token, id, {
      street,
      city,
      province,
      country,
    ...
    if (response.isSuccess()) {
      await alertService.success('Address created successfully');
          ...
          <div className="p-8">
            ...
            <form onSubmit={this.handleSubmit}>
              ...
              <div className="flex justify-end space-x-4">
                ...
                <button
                  type="submit"
                  className="px-5 py-3 bg-gradient-accent text-white rounded-lg hover:opacity-90 focus:outline-none transition-all duration-200 font-medium shadow-lg transform hover:-translate-y-0.5 flex items-center">
...
const AddressCreatePageWithRouter = withRouter(AddressCreatePage);

export default AddressCreatePageWithRouter;
