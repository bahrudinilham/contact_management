...
class UserLoginPage extends BaseComponent {
  constructor(props) {
    super(props);
    this.state = {
      username: '',
  ...
  async handleSubmit(event) {
    ...
    if (response.isSuccess()) {
      ...
      await alertService.success('Login successful');
...
const UserLoginPageWithRouter = withRouter(UserLoginPage);

export default UserLoginPageWithRouter;
